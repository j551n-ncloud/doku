...
\usepackage{glossaries} % muss als erstes eingebunden werden, da Meta/Packages ggfs. Sonderzeichen enthalten
...
\bibliographystyle{unsrtnat} % numerische Zitate in Zitationsreihenfolge
\input{Erklaerung}
