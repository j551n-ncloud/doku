...
toolunterstützt sind. Der Scope des Projekts ist für einen durchschnittlichen Prüfling
realistisch auf 40~Stunden ausgelegt -- insbesondere die
Beschäftigung mit dem Hardware-\ac{RAID}, der LDAP-Anbindung an
das Unternehmensverzeichnis, die Härtung über \texttt{firewalld},
die Anbindung an das \ac{Prometheus}-Monitoring per
\texttt{pbs-exporter} sowie die Konfiguration eines vollwertigen
Backup-Konzepts hätten bei einem ersten Kontakt mit den Themen
deutlich mehr Zeit erfordert. Dass die Konfigurationsphasen hier
schneller abgeschlossen werden konnten, geht u.\,a.\ auf
Vorerfahrung des Prüflings mit \ac{PVE} und \ac{PBS} aus einem
privaten Lab-Setup zurück. Der gesamte Dokumentationsaufwand von rund 10~Stunden verteilt sich
dabei etwa hälftig auf die Betriebsdokumentation für das
\ac{ODCF}-Team (siehe \Anhang{app:BetriebsDoku}) und die
vorliegende Projektdokumentation für die \ac{IHK}.
Eine vollständige Gegenüberstellung der
