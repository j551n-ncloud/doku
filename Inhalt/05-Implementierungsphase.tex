...
die Gesamtarchitektur der Blueprint-Lösung im Überblick.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth,keepaspectratio]{architecture}
    \caption{Gesamtarchitektur der PBS-Blueprint-Lösung:
...
\texttt{natrontech/pbs-exporter}~v0.8.0~\citep{PrometheusDocs} als
...
Zur Härtung des Hosts wird \texttt{firewalld} eingesetzt: Aktiv
