\begin{tabularx}{\textwidth}{Xrr}
    ...
    Hardware-\ac{RAID} und Backup-Datastore einrichten, Kapazitätsplanung und Quotas festlegen & 4 & \\ \hline
    \rowcolor{heading} 6. \ac{PVE}-Integration & & 4\  \\ \hline
    \ac{PBS} als Storage-Target in \ac{PVE} eintragen, Authentifizierung (\texttt{root}-Passwort / TLS-Fingerprint) konfigurieren & 4 & \\ \hline
